...
1.  Click the **Manage Rules and Workflows** button (<Icon icon="scale-balanced" />) at the bottom of the extension.
...
<Frame caption="Manage Workflows">
  <img src="https://storage.googleapis.com/cline_public_images/workflow-menu.gif" alt="Manage Rules and Workflows Interface" />
</Frame>
